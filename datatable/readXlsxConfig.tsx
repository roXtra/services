...
import { ErrorCodes } from "./readXlsx.js";
        ...
        <tbody>
          <tr>
            <td colSpan={2}>
              ...
              <p>
                {ErrorCodes.FILE_ERROR}: {tl("Die angegebene Datei konnte nicht gelesen werden.", userLanguage)}
              </p>
              <p>
                {ErrorCodes.SHEET_ERROR}: {tl("Das Arbeitsblatt konnte nicht gelesen werden.", userLanguage)}
              </p>
              <p>
                {ErrorCodes.FILTER_ERROR}: {tl("Es gab einen Fehler beim Auswerten des Filters.", userLanguage)}
              </p>
            </td>
          </tr>
        </tbody>
