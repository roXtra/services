...
describe("services", () => {
  describe("servicetemplate", () => {
    ...
    function performComplaintnrTest(bpmnXmlPath: string, bpmnTaskId: string, instances: IInstanceDetails[], tragetField: string): IServiceTaskEnvironment {
    ...
    it("execute complaintnr service test_8fd1ba08-f8a1-4caa-b685-27b3ee946038", () => {
      ...
      const env = performComplaintnrTest("./testfiles/complaintnr-test-process.bpmn", "ServiceTask_508AF9C8EEE3A181", instances, targetFieldName);
