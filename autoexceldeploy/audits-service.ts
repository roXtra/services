...
import { encodeKey, getFieldKey, getLaneKey } from "./utils/field-resolver.js";
...
export async function serviceLogic(environment: IServiceTaskEnvironment): Promise<void> {
  ...
  const options: IGenerateXLSXOptions = {
    ...
    auditsSettings: processDetails.auditsSettings,
...
export async function audits(environment: IServiceTaskEnvironment): Promise<boolean> {
