...
export function auditsConfig(userLanguage: Language): React.JSX.Element {
  return (
    <div id="service-form" className="ui form center">
      <table className="table table-striped table-bordered">
        <tbody>
          <tr>
            <td>
              <span>{tl("Audit-Prozess auswählen", userLanguage)}</span>
            </td>
            <td>
              <select id="processId" />
            </td>
          ...
          <tr>
            <td colSpan={2}>
              ...
              <div>
                <p>{tl("Geben Sie den Audit-Prozess an, aus dem der Excel-Bericht erzeugt werden soll.", userLanguage)}</p>
